...
### [Лабораторная работа №4](https://github.com/UliPi29/web_applications_labs/tree/main/lab_4). Разработка приложения для управления учётными записями пользователей (CRUD)
### [Лабораторная работа №5](https://github.com/UliPi29/web_applications_labs/tree/main/lab_5). Авторизация и статистические отчёты
### [Лабораторная работа №6](https://github.com/UliPi29/web_applications_labs/tree/main/lab_6). Доработка проекта "Образовательный портал"
